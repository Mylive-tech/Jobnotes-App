...
public class ReportPropertyFromLocationAdapter extends BaseAdapter {
    ...
    public ReportPropertyFromLocationAdapter(Activity activity, ArrayList<Property> alProperty) {
        super();
